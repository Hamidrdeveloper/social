...
import ButtonsProfileScreenTwo from './Components/ButtonProfileScreen/ButtonsProfileScreenTwo';

const ProfileScreenTwo = ({profileData, personalView = false,follow}) => {
